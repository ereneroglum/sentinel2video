...
if __name__ == '__main__':
  ...
  parser.add_argument('--min-water', help='Minimum water pixel percantage.', type=float, default=0.0)
  parser.add_argument('--max-water', help='Maximum water pixel percantage.', type=float, default=100.0)
  parser.add_argument('--min-nodata', help='Minimum no data pixel percantage.', type=float, default=0.0)
