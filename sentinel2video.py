...
if __name__ == '__main__':
  ...
  parser.add_argument('--bands', help='Bands', nargs='+', default=['B4', 'B3', 'B2'])
  ...
  parser.add_argument('--max', help='Gamma(s) to map to 255 for each band', nargs='+', default=[3000.0, 3000.0, 3000.0])
  ...
  parser.add_argument('--polling', help='Polling interval', type=int, default=5)
